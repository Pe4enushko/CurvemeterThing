...
/// </summary>
public class StateMachineCurvemeter : MonoBehaviour, ICoroutineRunner
{
    [Header("Заполните список шагов по порядку:")]
    [SerializeField] private Step<CurvemeterEvents, CurvemeterErrors>[] _steps;
    ...
    private IEnumerator<Step<CurvemeterEvents, CurvemeterErrors>> _enumerator;
    private Step<CurvemeterEvents, CurvemeterErrors> _currentSteps;

    public Step<CurvemeterEvents, CurvemeterErrors>[] Steps { get => _steps; }
    private void Awake()
    {
        ...
        IEnumerable<Step<CurvemeterEvents, CurvemeterErrors>> enumerable = _steps;
